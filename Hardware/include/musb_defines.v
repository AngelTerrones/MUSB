//==================================================================================================
//  Filename      : musb_defines.v
//  Created On    : 2014-09-23 20:23:51
//  Last Modified : 2015-05-09 14:27:12
//  Revision      :
...
//------------------------------------------------------------------------------
`define MUSB_SEG_0_SPACE_LOW    32'h0000_0000      // 256 MB: Internal Memory
`define MUSB_SEG_0_SPACE_HIGH   32'h0FFF_FFFF
`define MUSB_SEG_1_SPACE_LOW    32'h1000_0000      // 256 MB: I/O
`define MUSB_SEG_1_SPACE_HIGH   32'h1FFF_FFFF
`define MUSB_SEG_2_SPACE_LOW    32'h2000_0000      // 3.5 GB: External Memory
`define MUSB_SEG_3_SPACE_HIGH   32'hFFFF_FFFF

//------------------------------------------------------------------------------
// Endianess
// 0 -> little-endian. 1 -> big-endian
//------------------------------------------------------------------------------
`define MUSB_LITTLE_ENDIAN      0                   //
`define MUSB_BIG_ENDIAN         1                   //

//------------------------------------------------------------------------------
// Exception Vector
//------------------------------------------------------------------------------
`define MUSB_VECTOR_BASE_RESET      32'h0000_0010   // MIPS Standard is 0xBFC0_0000. Reset, soft-reset, NMI
`define MUSB_VECTOR_BASE_BOOT       32'h0000_0000   // MIPS Standard is 0xBFC0_0200. Bootstrap (Status_BEV = 1)
`define MUSB_VECTOR_BASE_NO_BOOT    32'h0000_0000   // MIPS Standard is 0x8000_0000. Normal (Status_BEV = 0)
`define MUSB_VECTOR_OFFSET_GENERAL  32'h0000_0000   // MIPS Standard is 0x0000_0180. General exception, but TBL
`define MUSB_VECTOR_OFFSET_SPECIAL  32'h0000_0008   // MIPS Standard is 0x0000_0200. Interrupts (Cause_IV = 1)
...
// Instructions fields
//------------------------------------------------------------------------------
`define MUSB_INSTR_OPCODE       31:26
`define MUSB_INSTR_RS           25:21
`define MUSB_INSTR_RT           20:16
`define MUSB_INSTR_RD           15:11
`define MUSB_INSTR_SHAMT        10:6
`define MUSB_INSTR_FUNCT        5:0
`define MUSB_INSTR_CP0_SEL      2:0
`define MUSB_INSTR_IMM16        15:0
`define MUSB_INSTR_IMM26        25:0
...
`define OP_BREAK                `OP_TYPE_R                      // New
`define OP_CLO                  `OP_TYPE_R2                     // New
`define OP_CLZ                  `OP_TYPE_R2                     // New
`define OP_DIV                  `OP_TYPE_R
`define OP_DIVU                 `OP_TYPE_R
`define OP_ERET                 `OP_TYPE_CP0                    // New
...
`define OP_LL                   6'b11_0000                      // New
`define OP_LUI                  6'b00_1111
`define OP_LW                   6'b10_0011
`define OP_MADD                 `OP_TYPE_R2                     // New
`define OP_MADDU                `OP_TYPE_R2                     // New
`define OP_MFC0                 `OP_TYPE_CP0                    // New
`define OP_MFHI                 `OP_TYPE_R
`define OP_MFLO                 `OP_TYPE_R
`define OP_MOVN                 `OP_TYPE_R                      // New
`define OP_MOVZ                 `OP_TYPE_R                      // New
`define OP_MSUB                 `OP_TYPE_R2                     // New
`define OP_MSUBU                `OP_TYPE_R2                     // New
`define OP_MTC0                 `OP_TYPE_CP0                    // New
...
`define OP_TEQ                  `OP_TYPE_R                      // New
`define OP_TEQI                 `OP_TYPE_REGIMM                 // New
`define OP_TGE                  `OP_TYPE_R                      // New
`define OP_TGEI                 `OP_TYPE_REGIMM                 // New
`define OP_TGEIU                `OP_TYPE_REGIMM                 // New
`define OP_TGEU                 `OP_TYPE_R                      // New
`define OP_TLT                  `OP_TYPE_R                      // New
`define OP_TLTI                 `OP_TYPE_REGIMM                 // New
`define OP_TLTIU                `OP_TYPE_REGIMM                 // New
`define OP_TLTU                 `OP_TYPE_R                      // New
`define OP_TNE                  `OP_TYPE_R                      // New
`define OP_TNEI                 `OP_TYPE_REGIMM                 // New
`define OP_XOR                  `OP_TYPE_R
`define OP_XORI                 6'b00_1110

//------------------------------------------------------------------------------
// Functions for R(2)-type instructions
//------------------------------------------------------------------------------
...
`define DP_JALR        {`ALU_OP_ADD,  16'b00_10_101010_01_0000} // because of Rs
`define DP_JR          {`ALU_OP_AND,  16'b00_00_000000_01_0000} // because of Rs
